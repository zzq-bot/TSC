...
class UniformTestSchedule:
    ...
    def init_build(self):
        ...
        num_npc = np.random.choice(range(self.maximum_npc_num), 1).item() + 1
        self.this_chosen_npc_idx = np.random.choice(range(self.args.n_agents), num_npc)
...
REGISTRY["uniform"] = UniformTestSchedule