...
def run_sequential(args, logger):
    ...
    # Default/Base scheme
    from icecream import ic
    ic(env_info["state_shape"], env_info["obs_shape"])
    scheme = {
    ...
    preprocess = {"actions": ("actions_onehot", [OneHot(out_dim=args.n_actions+1)])}
    # +1 as those not in the env is set to be "n_action"
