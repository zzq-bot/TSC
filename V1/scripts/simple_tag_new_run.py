...
if False:
    ...
    test_schedule = "test"
    name = "simple_tag_run_iter_10_ogn_5_mlp_ns_ttmax_750000_tmax_1250000_zdim_32_64_xi_2"
    seeds = [0, 1, 2]
    cuda_device = [5, 6, 7]
    recorder_load_path = ""
...
if False:
    ...
    train_schedule = "train"
    test_schedule = "test"
    name = "simple_tag_vanilla_qmix_iter_10_ogn_5_ttmax_750000_tmax_1250000_xi_2"
    seeds = [0, 1, 2]
    cuda_device = [3, 3, 3]
    recorder_load_path = ""
    test_function2 = False
