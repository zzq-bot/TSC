...
class Scenario(BaseScenario):
    def make_world(self):
        ...
        for i, agent in enumerate(world.agents):
            ...
            #agent.size = 0.09 if agent.adversary else 0.05
            agent.size = 0.12 if agent.adversary else 0.05
            agent.accel = 3.0 if agent.adversary else 10
            #agent.accel = 20.0 if agent.adversary else 25.0
            agent.max_speed = 1.0 if agent.adversary else 8
        # add landmarks
